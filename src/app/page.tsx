        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-sm text-gray-600">
              Projects live in your GitHub account. Pin them to your profile.
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-sm text-gray-600">
              Fork, branch, commit, PR. Learn the workflow used by professional
              development teams.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-sm text-gray-600">
              Unlike GitHub Classroom, your work stays with you forever. Build
